#!/usr/bin/env python
# A simpler version of Phoney Badger's pokemon-colorscripts tool: https://gitlab.com/phoneybadger/pokemon-colorscripts
import requests
import re
import os
import argparse
...
# A place where you store pokemon sprites. You can get these sprites using the -g/--generate option.
dir = "C:\\SGZ_Pro\\Hobbys\\Media\\pokemon\\art\\low\\"
