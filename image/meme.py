...
image = Image.open("C:\\SGZ_Pro\\Hobbys\\Drawings\\Digital_Art\\Blender\\Render\\kmart.png")
draw = ImageDraw.Draw(image)
dubai = ImageFont.truetype("C:\SGZ_Pro\Hobbys\Media\\ReemKufi-Regular.ttf", 100)
